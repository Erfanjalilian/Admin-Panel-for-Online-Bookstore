...
function EditForBestSellingProduct({ setShowModal, idData }) {
  ...
  useEffect(() => {
    async function fetchProduct() {
      const result = await fetch(`https://68938c84c49d24bce86b2434.mockapi.io/BestSelling/${idData}`);
  ...
  const handleSubmit = async () => {
    ...
    await fetch(`https://68938c84c49d24bce86b2434.mockapi.io/BestSelling/${idData}`, {
      method: "PUT",
...
export default EditForBestSellingProduct;
