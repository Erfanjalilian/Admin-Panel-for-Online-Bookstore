...
function Discount(){
    ...
    useEffect (()=>{
        ...
        async function handelData(){
            const result=await fetch("https://68938c84c49d24bce86b2434.mockapi.io/Discount")
    ...
    async function handelDeletData(id){
        const result=await fetch(`https://68938c84c49d24bce86b2434.mockapi.io/Discount/${id}`,
            {
                method:"DELETE"
            }
