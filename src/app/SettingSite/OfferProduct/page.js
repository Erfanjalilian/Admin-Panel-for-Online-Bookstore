...
import EditForDiscountProduct from "@/app/Componets/EditForDiscountProduct/EditForDiscountProduct"
...
function OfferProduct(){
    ...
    useEffect (()=>{
        ...
        async function handelData(){
            const result=await fetch("https://6895b158039a1a2b288ff540.mockapi.io/offerProject")
    ...
    async function handelDeletData(id){
        const result=await fetch(`https://6895b158039a1a2b288ff540.mockapi.io/offerProject/${id}`,
            {
                method:"DELETE"
            }
                  ...
                  <div className="flex-1">
                    <div className="w-[90%] mx-auto space-y-6">
                        <div className="text-left">
                            ...
                            {
                                showModal==true?
                                <EditForDiscountProduct idData={idData} setShowModal={setShowModal}  />
                                :
                                null
                            }
