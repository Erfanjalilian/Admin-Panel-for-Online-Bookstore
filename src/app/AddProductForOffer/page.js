...
function AddProductForOffer() {
  ...
  const imgbbApiKey = "dce76c91862741086d2ef22b13590f28"; // کلید API شما
  ...
  async function addProduct() {
    ...
    try {
      const response = await fetch(
        "https://6895b158039a1a2b288ff540.mockapi.io/offerProject",
        {
          method: "POST",
          headers: {
...
export default AddProductForOffer;
